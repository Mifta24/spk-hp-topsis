<x-layout>
        ...
        <div class="absolute inset-0 opacity-20">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" class="absolute bottom-0 left-0">
                <path fill="rgba(255,255,255,0.2)" fill-opacity="1"
                    d="M0,192L48,165.3C96,139,192,85,288,74.7C384,64,480,96,576,133.3C672,171,768,213,864,213.3C960,213,1056,171,1152,165.3C1248,160,1344,192,1392,208L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z">
                </path>
            </svg>
        </div>
        <div
            class="relative px-6 py-12 md:py-16 md:px-12 text-center md:text-left flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 md:pr-10 mb-8 md:mb-0">
                ...
                <p class="text-indigo-100 text-lg mb-8 max-w-lg">
                    Sistem rekomendasi handphone menggunakan metode TOPSIS untuk memberikan pilihan terbaik berdasarkan
                    preferensi Anda.
                </p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <a href="{{ route('recommendation') }}"
                        class="bg-white hover:bg-gray-100 text-indigo-700 font-medium py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300 flex items-center justify-center">
                        <i class="fas fa-search mr-2"></i> Cari Rekomendasi
                    </a>
                    <a href="{{ route('handphone.index') }}"
                        class="bg-transparent hover:bg-indigo-700 text-white border border-white py-3 px-6 rounded-lg flex items-center justify-center hover:shadow-lg transition duration-300">
            ...
            <div class="md:w-1/2 flex justify-center">
                <div class="relative w-64 h-72">
                    <!-- Phone mockup -->
                    <div
                        class="absolute inset-0 z-10 bg-black rounded-[40px] shadow-2xl overflow-hidden border-[8px] border-gray-800">
                        <!-- Video phone demo -->
                    ...
                    <!-- Decorative elements -->
                    <div class="absolute -right-16 -bottom-10 w-48 h-48 bg-pink-500 rounded-full opacity-20 blur-2xl">
                    </div>
    ...
    <div class="mb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="{{ route('handphone.index', ['price_range' => 'premium']) }}"
                class="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all p-5 text-white text-center">
            ...
            <a href="{{ route('handphone.index', ['feature' => 'camera']) }}"
                class="bg-gradient-to-br from-violet-500 to-purple-600 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all p-5 text-white text-center">
            ...
            <a href="{{ route('handphone.index', ['feature' => 'battery']) }}"
                class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all p-5 text-white text-center">
            ...
            <a href="{{ route('handphone.index', ['price_range' => 'budget']) }}"
                class="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all p-5 text-white text-center">
    ...
    <div class="mb-16">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <button id="prev-slide"
                    class="bg-gray-200 hover:bg-gray-300 text-gray-600 rounded-full w-8 h-8 flex items-center justify-center focus:outline-none transition">
        ...
        <div class="relative">
            <div id="phone-slider" class="overflow-hidden">
                <div id="slider-track" class="flex transition-transform duration-500 ease-out space-x-4"
                    style="transform: translateX(0);">
                    @foreach ($topHandphones as $phone)
                        <div class="min-w-[280px] md:min-w-[320px] flex-shrink-0">
                            <div
                                class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full border border-gray-100">
                                <div class="relative">
                                    ...
                                    @else
                                        <div class="w-full h-52 bg-gray-50 flex items-center justify-center">
                                            <span class="text-gray-400"><i
                                                    class="fas fa-mobile-alt text-5xl"></i></span>
                                        </div>
                                    @endif

                                    <div
                                        class="absolute top-2 right-2 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white text-xs py-1 px-3 rounded-full font-medium">
                                        {{ $phone->category }}
                                    </div>
                                </div>
                                <div class="p-5">
                                    <div class="mb-2">
                                        <h4 class="font-semibold text-lg text-gray-800 line-clamp-1">
                                            {{ $phone->name }}</h4>
                                        <p class="text-gray-700 font-medium">
                                            Rp{{ number_format($phone->price, 0, ',', '.') }}</p>
                                    </div>
                                    ...
                                    <a href="{{ route('handphone.detail', $phone->id) }}"
                                        class="mt-2 block text-center bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-2 px-3 rounded-lg transition">
                                        Lihat Detail
                                    </a>
                                </div>
                            </div>
            ...
            <div class="mt-4 flex justify-center md:hidden">
                <div class="flex space-x-1">
                    @foreach ($topHandphones as $index => $phone)
                        <button class="scroll-dot w-2 h-2 rounded-full bg-gray-300 focus:outline-none"
    ...
    <div class="mt-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg p-6 shadow-md border border-gray-100 text-center relative overflow-hidden">
                ...
                <div
                    class="rounded-full bg-indigo-100 w-16 h-16 flex items-center justify-center mx-auto mb-4 relative">
                    <i class="fas fa-sliders-h text-indigo-600 text-xl"></i>
                </div>
                <h4 class="font-semibold text-gray-800 mb-2">Masukkan Kriteria</h4>
                <p class="text-gray-600 text-sm">Tentukan rentang harga dan tingkat kepentingan untuk setiap kriteria
            ...
            <div class="bg-white rounded-lg p-6 shadow-md border border-gray-100 text-center relative overflow-hidden">
                ...
                <div
                    class="rounded-full bg-purple-100 w-16 h-16 flex items-center justify-center mx-auto mb-4 relative">
                    <i class="fas fa-calculator text-purple-600 text-xl"></i>
                </div>
                <h4 class="font-semibold text-gray-800 mb-2">Analisis TOPSIS</h4>
                <p class="text-gray-600 text-sm">Sistem akan melakukan perhitungan dengan metode TOPSIS untuk
                    memberikan peringkat handphone</p>
            </div>
            ...
            <div class="bg-white rounded-lg p-6 shadow-md border border-gray-100 text-center relative overflow-hidden">
                ...
                <p class="text-gray-600 text-sm">Lihat daftar handphone yang paling sesuai dengan kriteria yang Anda
                    tentukan</p>
            </div>
        </div>
    </div>
