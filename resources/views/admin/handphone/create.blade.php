        ...
        <form action="{{ route('admin.handphone.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- Price -->
                    <div>
                        <label for="price" class="block text-sm font-medium text-gray-700 mb-1">Harga (Rp) <span class="text-red-600">*</span></label>
                        <input type="number" name="price" id="price" value="{{ old('price') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-data="{ imageUrl: '', useUrl: false }">
                            ...
                            <div x-show="!useUrl" class="mb-2">
                                ...
                                <p class="text-xs text-gray-500 mt-1">Ukuran yang direkomendasikan: 500x500 piksel, maks 2MB</p>
                            </div>

                            <div x-show="useUrl" class="mb-2">
                                <input type="text" name="image_url" id="image_url" value="{{ old('image_url') }}" x-model="imageUrl" placeholder="https://example.com/image.jpg" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            </div>
                    ...
                    <!-- Processor Name -->
                    <div>
                        <label for="processor_name" class="block text-sm font-medium text-gray-700 mb-1">Nama Prosesor <span class="text-red-600">*</span></label>
                        <input type="text" name="processor_name" id="processor_name" value="{{ old('processor_name') }}" placeholder="contoh: Snapdragon 8 Gen 2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- Camera Detail -->
                    <div>
                        <label for="camera_detail" class="block text-sm font-medium text-gray-700 mb-1">Detail Kamera <span class="text-red-600">*</span></label>
                        <input type="text" name="camera_detail" id="camera_detail" value="{{ old('camera_detail') }}" placeholder="contoh: 50 MP (wide) + 12 MP (ultrawide)" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- Battery Capacity -->
                    <div>
                        <label for="battery_capacity" class="block text-sm font-medium text-gray-700 mb-1">Kapasitas Baterai <span class="text-red-600">*</span></label>
                        <input type="text" name="battery_capacity" id="battery_capacity" value="{{ old('battery_capacity') }}" placeholder="contoh: 5000 mAh Li-Po" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- RAM Size -->
                    <div>
                        <label for="ram_size" class="block text-sm font-medium text-gray-700 mb-1">Ukuran RAM <span class="text-red-600">*</span></label>
                        <input type="text" name="ram_size" id="ram_size" value="{{ old('ram_size') }}" placeholder="contoh: 8 GB" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- Storage Size -->
                    <div>
                        <label for="storage_size" class="block text-sm font-medium text-gray-700 mb-1">Ukuran Penyimpanan <span class="text-red-600">*</span></label>
                        <input type="text" name="storage_size" id="storage_size" value="{{ old('storage_size') }}" placeholder="contoh: 128 GB / 256 GB" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- Screen Size -->
                    <div>
                        <label for="screen_size" class="block text-sm font-medium text-gray-700 mb-1">Ukuran Layar <span class="text-red-600">*</span></label>
                        <input type="text" name="screen_size" id="screen_size" value="{{ old('screen_size') }}" placeholder="contoh: 6.5 inches AMOLED, 120Hz" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>

                    <!-- OS Version -->
                    <div>
                        <label for="os_version" class="block text-sm font-medium text-gray-700 mb-1">Versi OS <span class="text-red-600">*</span></label>
                        <input type="text" name="os_version" id="os_version" value="{{ old('os_version') }}" placeholder="contoh: Android 13, One UI 5.1" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                    </div>
                    ...
                    <div class="md:col-span-2" x-data="{ open: false }">
                        ...
                        <div x-show="open" class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            ...
                            <div>
                                ...
                                <select name="network" id="network" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                                    <option value="">Pilih Jaringan</option>
                                    <option value="5G" {{ old('network') == '5G' ? 'selected' : '' }}>5G</option>
                                    <option value="4G LTE" {{ old('network') == '4G LTE' ? 'selected' : '' }}>4G LTE</option>
                            ...
                            <div>
                                ...
                                <input type="text" name="sim" id="sim" value="{{ old('sim') }}" placeholder="contoh: Dual SIM (Nano-SIM)" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            </div>

                            <!-- Weight -->
                            <div>
                                <label for="weight" class="block text-sm font-medium text-gray-700 mb-1">Berat</label>
                                <input type="text" name="weight" id="weight" value="{{ old('weight') }}" placeholder="contoh: 195 g" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            </div>

                            <!-- Dimensions -->
                            <div>
                                <label for="dimensions" class="block text-sm font-medium text-gray-700 mb-1">Dimensi</label>
                                <input type="text" name="dimensions" id="dimensions" value="{{ old('dimensions') }}" placeholder="contoh: 162.9 x 76.6 x 8.9 mm" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Colors -->
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Warna yang Tersedia <span class="text-red-600">*</span></label>
                        <div x-data="{ colors: [], newColor: '' }">
                            <div class="flex">
                                <input type="text" x-model="newColor" placeholder="Tambahkan warna" class="w-full rounded-l-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Masukkan warna satu per satu (contoh: Hitam, Biru, dll.)</p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div x-data="{ features: [], newFeature: '' }">
                            <div class="flex">
                                <input type="text" x-model="newFeature" placeholder="Tambahkan fitur" class="w-full rounded-l-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Masukkan fitur satu per satu (contoh: Fast charging, NFC, dll.)</p>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
