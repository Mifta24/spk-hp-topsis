...
<x-admin-layout header="Edit Handphone">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('admin.handphone.update', $handphone->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $handphone->name) }}"
                        ...
                        <select name="brand_id" id="brand_id"
                            ...
                            @foreach (\App\Models\Brand::orderBy('name')->get() as $brand)
                                <option value="{{ $brand->id }}"
                                    ...
                                    {{ $brand->name }} {{ !$brand->is_active ? '(Tidak Aktif)' : '' }}
                                </option>
                            @endforeach
                        </select>
                        @error('brand_id')
                    ...
                    <div>
                        ...
                        <input type="number" name="price" id="price"
                            value="{{ old('price', $handphone->price) }}"
                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            required>
                        @error('price')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="camera" id="camera" min="1" max="10"
                                value="{{ old('camera', $handphone->camera) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->camera }}</output>
                        </div>
                        @error('camera')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="battery" id="battery" min="1" max="10"
                                value="{{ old('battery', $handphone->battery) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->battery }}</output>
                        </div>
                        @error('battery')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="ram" id="ram" min="1" max="10"
                                value="{{ old('ram', $handphone->ram) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->ram }}</output>
                        </div>
                        @error('ram')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="prosessor" id="prosessor" min="1" max="10"
                                value="{{ old('prosessor', $handphone->prosessor) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->prosessor }}</output>
                        </div>
                        @error('prosessor')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="design" id="design" min="1" max="10"
                                value="{{ old('design', $handphone->design) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->design }}</output>
                        </div>
                        @error('design')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input type="range" name="storage" id="storage" min="1" max="10"
                                value="{{ old('storage', $handphone->storage) }}"
                                class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer"
                                oninput="this.nextElementSibling.value = this.value">
                            <output
                                class="w-10 text-center text-sm font-medium text-gray-700 ml-2">{{ $handphone->storage }}</output>
                        </div>
                        @error('storage')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                ...
                @if ($handphone->specification)
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-1">URL
                                Gambar</label>
                            <div x-data="{ imageUrl: '{{ old('image_url', $handphone->specification->image) }}', useUrl: true }">
                                ...
                                <div x-show="!useUrl" class="mb-2">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Ukuran yang direkomendasikan: 500x500 pixels,
                                        max 2MB</p>
                                </div>

                                <div x-show="useUrl" class="mb-2">
                                    <input type="text" name="image_url" id="image_url" x-model="imageUrl"
                        ...
                        <!-- Processor Name -->
                        <div>
                            <label for="processor_name" class="block text-sm font-medium text-gray-700 mb-1">Nama
                                Prosesor</label>
                            <input type="text" name="processor_name" id="processor_name"
                                value="{{ old('processor_name', $handphone->specification->processor_name) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>

                        <!-- Camera Details -->
                        <div>
                            <label for="camera_detail" class="block text-sm font-medium text-gray-700 mb-1">Detail
                                Kamera</label>
                            <input type="text" name="camera_detail" id="camera_detail"
                                value="{{ old('camera_detail', $handphone->specification->camera_detail) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            <label for="battery_capacity"
                                class="block text-sm font-medium text-gray-700 mb-1">Kapasitas Baterai</label>
                            <input type="text" name="battery_capacity" id="battery_capacity"
                                value="{{ old('battery_capacity', $handphone->specification->battery_capacity) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>

                        <!-- RAM Size -->
                        <div>
                            <label for="ram_size" class="block text-sm font-medium text-gray-700 mb-1">Ukuran
                                RAM</label>
                            <input type="text" name="ram_size" id="ram_size"
                                value="{{ old('ram_size', $handphone->specification->ram_size) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="storage_size" id="storage_size"
                                value="{{ old('storage_size', $handphone->specification->storage_size) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>

                        <!-- Screen Size -->
                        <div>
                            <label for="screen_size" class="block text-sm font-medium text-gray-700 mb-1">Ukuran
                                Layar</label>
                            <input type="text" name="screen_size" id="screen_size"
                                value="{{ old('screen_size', $handphone->specification->screen_size) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>

                        <!-- OS Version -->
                        <div>
                            <label for="os_version" class="block text-sm font-medium text-gray-700 mb-1">Versi
                                OS</label>
                            <input type="text" name="os_version" id="os_version"
                                value="{{ old('os_version', $handphone->specification->os_version) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="network" id="network"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <option value="5G"
                                    {{ old('network', $handphone->specification->network) == '5G' ? 'selected' : '' }}>
                                    5G</option>
                                <option value="4G LTE"
                                    {{ old('network', $handphone->specification->network) == '4G LTE' ? 'selected' : '' }}>
                                    4G LTE</option>
                                <option value="3G"
                                    {{ old('network', $handphone->specification->network) == '3G' ? 'selected' : '' }}>
                                    3G</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="sim" id="sim"
                                value="{{ old('sim', $handphone->specification->sim) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="weight" id="weight"
                                value="{{ old('weight', $handphone->specification->weight) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="dimensions" id="dimensions"
                                value="{{ old('dimensions', $handphone->specification->dimensions) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>

                        <!-- Colors -->
                        <div class="md:col-span-2">
                            <label for="colors" class="block text-sm font-medium text-gray-700 mb-1">Warna yang
                                Tersedia</label>
                            <div x-data="{
                                ...
                                <p class="text-xs text-gray-500 mt-1">Masukkan warna satu per satu (mis. Hitam, Biru,
                                    dll.)</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div x-data="{
                                ...
                                <p class="text-xs text-gray-500 mt-1">Masukkan fitur satu per satu (mis. Fast charging,
                                    NFC, dll.)</p>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('description', $handphone->specification->description) }}</textarea>
                        </div>
                    </div>
                @else
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">Belum ada data spesifikasi untuk handphone ini. Data
                                    spesifikasi akan dibuat otomatis saat Anda menyimpan.</p>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('admin.handphone.index') }}"
                    class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-2 px-4 rounded inline-flex items-center transition-colors">
                    <i class="fas fa-times mr-2"></i> Batal
                </a>
                <button type="submit"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded inline-flex items-center transition-colors">
